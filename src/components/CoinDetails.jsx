...
const CoinDetails = () => {
  ...
  const btns=["1d","7d","15d","30d","60d","200d","365d","max"];
  ...
  useEffect(() =>{
   ...
   if(error) return <ErrorComponenet message={"Error while fetching Coin Deteails"}/>;
          ...
          <RadioGroup value={currency} onChange = {setCurrency} p={"4"} >
           <HStack spacing={"4"} >
            ...
            <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
             <Text fontSize={"small"} alignSelf={'center'} opacity={"0.88"}>
               Last Updated On{" "} {Date(coin.market_data.last_updated).split("G")[0]}
             </Text>
             <Image src={coin.image.large} w={"24"} h={"24"} objectFit={"contain"} />
              ...
              <Badge fontSize={"24"} bgColor={"blackAlpha.900"} color={"white"}>
